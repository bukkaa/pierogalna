package com.bkk.views.orderstatus;
...
@Route(value = "order-status", layout = MainLayout.class)
public class OrderStatusView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public OrderStatusView() {
        addClassName("order-status-view");
        setSizeFull();
        grid.setHeight("100%");
