package com.bkk.views.readytotake;
...
@PageTitle("Ready to take!")
@Route(value = "orders-ready", layout = MainLayout.class)
public class ReadytotakeView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ReadytotakeView() {
        addClassName("readytotake-view");
        setSizeFull();
        grid.setHeight("100%");
